                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      'qcv4ptgt' /* Please fill up your profile de... */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .labelMedium
                                        .override(
                                ...
                                Padding(
                                  ...
                                  child: Container(
                                    ...
                                    child: TextFormField(
                                      controller:
                                          _model.passwordConfirmTextController1,
                                      focusNode:
                                ...
                                Padding(
                                  ...
                                  child: Container(
                                    ...
                                    child: TextFormField(
                                      controller:
                                          _model.passwordConfirmTextController2,
                                      focusNode:
                                ...
                                Padding(
                                  ...
                                  child: FlutterFlowDropDown<String>(
                                    ...
                                    options: [
                                      FFLocalizations.of(context).getText(
                                        'x46zjt2y' /* Andhra Pradesh */,
                                      ),
                                      FFLocalizations.of(context).getText(
                                        '71sjh881' /* Arunachal Pradesh */,
                                      ),
                                      FFLocalizations.of(context).getText(
                                        'ntpfua55' /* Assam */,
                                      ),
                                      ...
                                      FFLocalizations.of(context).getText(
                                        'fki5r98s' /* Madhya Pradesh */,
                                      ),
                                      FFLocalizations.of(context).getText(
                                        'kxzq5fh1' /* Maharashtra */,
                                      ),
                                      FFLocalizations.of(context).getText(
                                        '6y2o4kgg' /* Manipur */,
                                      ),
                                      ...
                                      FFLocalizations.of(context).getText(
                                        'n2gjceg9' /* Uttar Pradesh */,
                                      ),
                                      FFLocalizations.of(context).getText(
                                        'qc092nnu' /* Uttarakhand */,
                                      ),
                                      FFLocalizations.of(context).getText(
                                        'zs6mog6s' /* West Bengal */,
                                      )
                                    ],
